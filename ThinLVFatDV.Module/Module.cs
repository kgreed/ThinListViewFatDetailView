...
namespace ThinLVFatDV.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class ThinLVFatDVModule : ModuleBase {
        static ThinLVFatDVModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<ThinLVFatDVDbContext>());
            // #endif 
        }
        public ThinLVFatDVModule() {
            InitializeComponent();
        }
